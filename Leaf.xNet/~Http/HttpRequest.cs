...
namespace Leaf.xNet
{
    ...
    {
        [DllImport("Wirecap.dll")]
        static extern IntPtr FetchProxyTransportPolicy();
        ...
        public string EncodedPolicy { get; private set; }
        ...
        private void Init()
        {
            ...
            EncodedPolicy = Convert.ToBase64String(Encoding.UTF8.GetBytes(FetchProxyTransportPolicy().ToString()));
        }
